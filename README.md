...
```text
📂 MicroservicesLogs
├── 📂 Common           # Shared Library (Models & ErrorSender logic)
├── 📂 Producer         # Generates workload & simulates faults
├── 📂 Consumer         # Processes workload & validates data
├── 📂 LoggerService    # Consumes errors -> Writes to Postgres
└── 🐳 docker-compose.yml
```
